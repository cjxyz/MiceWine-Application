...
Java_com_nianticlabs_pokemongo_CmdEntryPoint_start(JNIEnv *env, unused jclass cls, jobjectArray args) {
    pthread_t t;
    JavaVM* vm = NULL;
...
Java_com_nianticlabs_pokemongo_CmdEntryPoint_windowChanged(JNIEnv *env, unused jobject cls, jobject surface) {
...
Java_com_nianticlabs_pokemongo_CmdEntryPoint_getXConnection(JNIEnv *env, unused jobject cls) {
    int client[2];
...
JNIEXPORT jobject JNICALL
Java_com_nianticlabs_pokemongo_CmdEntryPoint_getLogcatOutput(JNIEnv *env, unused jobject cls) {
    jclass ParcelFileDescriptorClass = (*env)->FindClass(env, "android/os/ParcelFileDescriptor");
    jmethodID adoptFd = (*env)->GetStaticMethodID(env, ParcelFileDescriptorClass, "adoptFd", "(I)Landroid/os/ParcelFileDescriptor;");
...
JNIEXPORT jboolean JNICALL
Java_com_nianticlabs_pokemongo_CmdEntryPoint_connected(__unused JNIEnv *env, __unused jclass clazz) {
    return conn_fd != -1;
}
...
static inline void checkConnection(JNIEnv* env) {
    ...
    if ((retval = recv(conn_fd, &b, 1, MSG_PEEK)) <= 0 && errno != EAGAIN) {
        ...
        jclass cls = (*env)->FindClass(env, "com/nianticlabs/pokemongo/CmdEntryPoint");
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_connect(unused JNIEnv* env, unused jobject cls, jint fd) {
    if (!Charset.self) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_handleXEvents(JNIEnv *env, jobject thiz) {
    checkConnection(env);
    if (conn_fd != -1) {
        lorieEvent e = {0};
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_startLogcat(JNIEnv *env, unused jobject cls, jint fd) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_setClipboardSyncEnabled(unused JNIEnv* env, unused jobject cls, jboolean enable, __unused jboolean ignored) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendClipboardAnnounce(JNIEnv *env, jobject thiz) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendClipboardEvent(JNIEnv *env, unused jobject thiz, jbyteArray text) {
    if (conn_fd != -1 && text) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendWindowChange(unused JNIEnv* env, unused jobject cls, jint width, jint height, jint framerate) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendMouseEvent(unused JNIEnv* env, unused jobject cls, jfloat x, jfloat y, jint which_button, jboolean button_down, jboolean relative) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendTouchEvent(unused JNIEnv* env, unused jobject cls, jint action, jint id, jint x, jint y) {
...
JNIEXPORT jboolean JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendKeyEvent(unused JNIEnv* env, unused jobject cls, jint scan_code, jint key_code, jboolean key_down) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendTextEvent(JNIEnv *env, unused jobject thiz, jbyteArray text) {
    if (conn_fd != -1 && text) {
        jsize length = (*env)->GetArrayLength(env, text);
        jbyte *str = (*env)->GetByteArrayElements(env, text, NULL);
        char *p = (char*) str;
...
JNIEXPORT void JNICALL
Java_com_nianticlabs_pokemongo_LorieView_sendUnicodeEvent(JNIEnv *env, unused jobject thiz, jint code) {
    if (conn_fd != -1) {
...
__attribute__((constructor)) static void init(void) {
    pthread_t t;
    if (!strcmp("com.nianticlabs.pokemongo", __progname))
